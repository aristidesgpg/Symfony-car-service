...
{
    /**
     * @var \App\Soap\dealerbuilt\src\BaseApi\PushCounterTicketApiResponseType
     */
     ...
     * @return self
     */
    public function setPushCounterTicketsResult(BaseApi\PushCounterTicketApiResponseType $pushCounterTicketsResult)
    {
