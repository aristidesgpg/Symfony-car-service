...
class PullAfterMarketProduct
{
    ...
    /**
     * @var \App\Soap\dealerbuilt\src\BaseApi\AfterMarketProductsSearchCriteriaType $searchCriteria
     */
     ...
     * @return self
     */
    public function setSearchCriteria(\App\Soap\dealerbuilt\src\BaseApi\AfterMarketProductsSearchCriteriaType $searchCriteria)
    {
