...
class GetProducts
{
    ...
    /**
     * @var \App\Soap\dealerbuilt\src\BaseApi\ProductSearchCriteriaType $searchCriteria
     */
     ...
     * @return self
     */
    public function setSearchCriteria(\App\Soap\dealerbuilt\src\BaseApi\ProductSearchCriteriaType $searchCriteria)
    {
