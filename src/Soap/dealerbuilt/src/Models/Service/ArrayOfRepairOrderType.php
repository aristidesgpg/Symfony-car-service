...
class ArrayOfRepairOrderType
{
    ...
    /**
     * @var \App\Soap\dealerbuilt\src\Models\Service\RepairOrderType[] $repairOrder
     */
    private $repairOrder = [
     ...
     */
    public function addToRepairOrder(\App\Soap\dealerbuilt\src\Models\Service\RepairOrderType $repairOrder)
    {
