...
/**
 * Class representing PushedLaborOperationSubletAttributesType
 *
 * 
 * XSD Type: PushedLaborOperationSubletAttributes
 */
class PushedLaborOperationSubletAttributesType
{
     ...
     * @return string
     */
    public function getExternalSubletId()
    {
        return $this->externalSubletId;
    }
