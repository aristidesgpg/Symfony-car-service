...
class BuyFeeCollectionType
{
     ...
     * @return self
     */
    public function setBank(StandardFeeType $bank)
    {
        $this->bank = $bank;
     ...
     * @return self
     */
    public function setLicensing(StandardFeeType $licensing)
    {
     ...
     * @return self
     */
    public function setLoanOrigination(StandardFeeType $loanOrigination)
    {
     ...
     * @return self
     */
    public function setLoanProcessing(StandardFeeType $loanProcessing)
    {
     ...
     * @return self
     */
    public function setProratedLicensing(StandardFeeType $proratedLicensing)
    {
     ...
     * @return self
     */
    public function setTradeLicensing(StandardFeeType $tradeLicensing)
    {
