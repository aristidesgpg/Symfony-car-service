...
class ArrayOfDealerTaxType
{
    ...
    /**
     * @var \App\Soap\dealerbuilt\src\Models\Sales\DealerTaxType[] $dealerTax
     */
    private $dealerTax = [
     ...
     */
    public function addToDealerTax(\App\Soap\dealerbuilt\src\Models\Sales\DealerTaxType $dealerTax)
    {
