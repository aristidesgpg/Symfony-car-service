...
class AfterMarketServiceProdutPullResponseType
{
     ...
     * @return string
     */
    public function getAfterSaleFinancemGrid()
    {
        return $this->afterSaleFinancemGrid;
    }
     ...
     * @return string
     */
    public function getAfterSaleLocationid()
    {
        return $this->afterSaleLocationid;
    }
     ...
     * @return string
     */
    public function getCoverageMonths()
    {
        return $this->coverageMonths;
    }
     ...
     * @return string
     */
    public function getLyvehicleSeq()
    {
        return $this->lyvehicleSeq;
    }
