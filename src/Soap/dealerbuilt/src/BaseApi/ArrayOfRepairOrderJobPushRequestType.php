...
{
    /**
     * @var \App\Soap\dealerbuilt\src\BaseApi\RepairOrderJobPushRequestType[]
     */
     ...
     */
    public function addToRepairOrderJobPushRequest(RepairOrderJobPushRequestType $repairOrderJobPushRequest)
    {
