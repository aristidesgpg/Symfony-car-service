...
class LaborOperationSubletPushRequestType
{
    ...
    /**
     * @var \App\Soap\dealerbuilt\src\BaseApi\PushedLaborOperationSubletType $sublet
     */
    private $sublet = null;
     ...
     * @return self
     */
    public function setSublet(\App\Soap\dealerbuilt\src\BaseApi\PushedLaborOperationSubletType $sublet)
    {
        $this->sublet = $sublet;
        return $this;
    }
