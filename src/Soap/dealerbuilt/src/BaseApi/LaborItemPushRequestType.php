...
class LaborItemPushRequestType
{
    ...
    /**
     * @var \App\Soap\dealerbuilt\src\BaseApi\PushedLaborItemType $laborItem
     */
     ...
     * @return self
     */
    public function setLaborItem(\App\Soap\dealerbuilt\src\BaseApi\PushedLaborItemType $laborItem)
    {
