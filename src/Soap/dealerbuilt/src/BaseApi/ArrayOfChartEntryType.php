...
class ArrayOfChartEntryType
{
    ...
    /**
     * @var \App\Soap\dealerbuilt\src\BaseApi\ChartEntryType[] $chartEntry
     */
    private $chartEntry = [
     ...
     */
    public function addToChartEntry(\App\Soap\dealerbuilt\src\BaseApi\ChartEntryType $chartEntry)
    {
