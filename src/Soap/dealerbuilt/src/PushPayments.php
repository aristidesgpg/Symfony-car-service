...
class PushPayments
{
    ...
    /**
     * @var \App\Soap\dealerbuilt\src\BaseApi\PaymentPushRequestType[] $request
     */
     ...
     */
    public function addToRequest(\App\Soap\dealerbuilt\src\BaseApi\PaymentPushRequestType $paymentPushRequest)
    {
