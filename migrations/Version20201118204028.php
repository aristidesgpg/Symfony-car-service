 ...
 */
final class Version20201118204028 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE repair_order ADD note LONGTEXT DEFAULT NULL, ADD archived TINYINT(1) NOT NULL, CHANGE primary_technician_id primary_technician_id INT DEFAULT NULL, CHANGE primary_advisor primary_advisor_id INT NOT NULL');
