...
final class Version20201105164447 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE inspection_group (id INT AUTO_INCREMENT NOT NULL, mpi_template_id_id INT NOT NULL, name VARCHAR(255) NOT NULL, active TINYINT(1) NOT NULL, deleted TINYINT(1) NOT NULL, INDEX IDX_79EB0AE9B4CD962C (mpi_template_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE mpiitem (id INT AUTO_INCREMENT NOT NULL, mpi_inspection_group_id_id INT NOT NULL, name VARCHAR(255) NOT NULL, has_range TINYINT(1) NOT NULL, range_maximum INT DEFAULT NULL, range_unit VARCHAR(255) DEFAULT NULL, deleted TINYINT(1) NOT NULL, INDEX IDX_D65210A4AA3D9B9A (mpi_inspection_group_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE mpitemplate (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, active TINYINT(1) NOT NULL, deleted TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
