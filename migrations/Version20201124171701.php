...
final class Version20201124171701 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE repair_order_quote_service ADD CONSTRAINT FK_C5F8B26C8293E9BE FOREIGN KEY (repair_order_quote_id) REFERENCES repair_order_quote (id)');
        $this->addSql('ALTER TABLE repair_order_quote_service ADD CONSTRAINT FK_C5F8B26C841B7EDA FOREIGN KEY (operation_code_id) REFERENCES operation_code (id)');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE repair_order_quote_service DROP FOREIGN KEY FK_C5F8B26C841B7EDA');
        $this->addSql('ALTER TABLE repair_order_quote_service DROP FOREIGN KEY FK_C5F8B26C8293E9BE');
        $this->addSql('DROP TABLE operation_code');
        $this->addSql('DROP TABLE repair_order_quote');
        $this->addSql('DROP TABLE repair_order_quote_service');
    }
}
