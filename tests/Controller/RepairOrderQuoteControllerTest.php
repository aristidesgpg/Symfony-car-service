...
class RepairOrderQuoteControllerTest extends WebTestCase
{
    ...
    public function testCreateRepairOrderQuote()
    {
        ...
        $params = [
            ...
            'recommendations' => '[{"operationCode":"MCS", "description":"Neque maxime ex dolorem ut.","preApproved":true,"approved":true,"laborHours":5,"partsPrice":1.0,"suppliesPrice":14.02,"laborPrice":5.3,"laborTax":5.3,"partsTax":2.1,"suppliesTax":4.3,"notes":"Cumque tempora ut nobis."},{"operationCode":"VDF", "description":"Quidem earum sapiente at dolores quia natus.","preApproved":false,"approved":true,"laborHours":6,"partsPrice":2.6,"suppliesPrice":509.02,"laborPrice":36.9,"laborTax":4.3,"partsTax":2.4,"suppliesTax":4.1,"notes":"Et accusantium rerum."},{"operationCode":"TER", "description":"Mollitia unde nobis doloribus sed.","preApproved":true,"approved":false,"laborHours":5,"partsPrice":1.1,"suppliesPrice":71.7,"laborPrice":55.1,"laborTax":5.1,"partsTax":2.6,"suppliesTax":3.3,"notes":"Voluptates et aut debitis."}]',
        ];
        $this->requestAction('POST', '', $params);
        $this->assertResponseIsSuccessful();
        $response = json_decode($this->client->getResponse()->getContent());
        ...
        $params = [
            'repairOrderID' => $repairOrderId,
            'recommendations' => '[operationCode":"MCS", "description":"Neque maxime ex dolorem ut.","preApproved":true,"approved":true,"laborHours":5, "partsPrice":1.0,"suppliesPrice":14.02,"laborPrice":5.3,"laborTax":5.3,"partsTax":2.1,"suppliesTax":4.3,"notes":"Cumque tempora ut nobis.", "parts":[{"number":"34843434", "name":"name1", "price":23.3, "quantity":23,"bin":"eifkdo838f833kd9"}, {"number":"12254345", "name":"name2", "price":13.3, "quantity":13,"bin":"dkf939f8d8f8dd"}]},{"operationCode":"VDF", "description":"Quidem earum sapiente at dolores quia natus.","preApproved":false,"approved":true,"laborHours":6,"partsPrice":2.6,"suppliesPrice":509.02,"laborPrice":36.9,"laborTax":4.3,"partsTax":2.4,"suppliesTax":4.1,"notes":"Et accusantium rerum."},{"operationCode":"TER", "description":"Mollitia unde nobis doloribus sed.","preApproved":true,"approved":false,"laborHours":7,"partsPrice":1.1,"suppliesPrice":71.7,"laborPrice":55.1,"laborTax":5.1,"partsTax":2.6,"suppliesTax":3.3,"notes":"Voluptates et aut debitis."}]',
        ];
        $this->requestAction('POST', '', $params);
        $this->assertEquals(Response::HTTP_BAD_REQUEST, $this->client->getResponse()->getStatusCode());
        ...
        $params = [
            'repairOrderID' => $repairOrderId,
            'recommendations' => 'operationCode":"MCS", "description":"Neque maxime ex dolorem ut.","preApproved":true,"approved":true,"laborHours":5,"partsPrice":1.0,"suppliesPrice":14.02,"laborPrice":5.3,"laborTax":5.3,"partsTax":2.1,"suppliesTax":4.3,"notes":"Cumque tempora ut nobis.", "parts":[{"number":"34843434", "name":"name1", "price":23.3, "quantity":23,"bin":"eifkdo838f833kd9"}, {"number":"12254345", "name":"name2", "price":13.3, "quantity":13,"bin":"dkf939f8d8f8dd"}]},{"operationCode":"VDF", "description":"Quidem earum sapiente at dolores quia natus.","preApproved":false,"approved":true,"laborHours":5,"partsPrice":2.6,"suppliesPrice":509.02,"laborPrice":36.9,"laborTax":4.3,"partsTax":2.4,"suppliesTax":4.1,"notes":"Et accusantium rerum."},{"operationCode":"TER", "description":"Mollitia unde nobis doloribus sed.","preApproved":true,"approved":false,"laborHours":5,"partsPrice":1.1,"suppliesPrice":71.7,"laborPrice":55.1,"laborTax":5.1,"partsTax":2.6,"suppliesTax":3.3,"notes":"Voluptates et aut debitis."}]',
        ];
        $this->requestAction('POST', '', $params);
        $this->assertEquals(Response::HTTP_BAD_REQUEST, $this->client->getResponse()->getStatusCode());
        ...
        $params = [
            'repairOrderID' => $repairOrderId,
            'recommendations' => '[operationCode":"MCS", "preApproved":true,"approved":true,"laborHours":5,"partsPrice":1.0,"suppliesPrice":14.02,"laborPrice":5.3,"laborTax":5.3,"partsTax":2.1,"suppliesTax":4.3,"notes":"Cumque tempora ut nobis.", "parts":[{"number":"34843434", "name":"name1", "price":23.3, "quantity":23,"bin":"eifkdo838f833kd9"}, {"number":"12254345", "name":"name2", "price":13.3, "quantity":13,"bin":"dkf939f8d8f8dd"}]},{"operationCode":"VDF", "description":"Quidem earum sapiente at dolores quia natus.","preApproved":false,"approved":true,"laborHours":5,"partsPrice":2.6,"suppliesPrice":509.02,"laborPrice":36.9,"laborTax":4.3,"partsTax":2.4,"suppliesTax":4.1,"notes":"Et accusantium rerum."},{"operationCode":"TER", "description":"Mollitia unde nobis doloribus sed.","preApproved":true,"approved":false,"laborHours":5,"partsPrice":1.1,"suppliesPrice":71.7,"laborPrice":55.1,"laborTax":5.1,"partsTax":2.6,"suppliesTax":3.3,"notes":"Voluptates et aut debitis."}]',
        ];
        $this->requestAction('POST', '', $params);
        $this->assertEquals(Response::HTTP_BAD_REQUEST, $this->client->getResponse()->getStatusCode());
        ...
        $params = [
            'repairOrderID' => $repairOrderId,
            'recommendations' => '[{"operationCode":"MCS", "description":"","preApproved":true,"approved":true,"laborHours":5,"partsPrice":1.0,"suppliesPrice":14.02,"laborPrice":5.3,"laborTax":5.3,"partsTax":2.1,"suppliesTax":4.3,"notes":"Cumque tempora ut nobis.", "parts":[{"number":"34843434", "name":"name1", "price":23.3, "quantity":23,"bin":"eifkdo838f833kd9"}, {"number":"12254345", "name":"name2", "price":13.3, "quantity":13,"bin":"dkf939f8d8f8dd"}]},{"operationCode":"VDF", "description":"Quidem earum sapiente at dolores quia natus.","preApproved":false,"approved":true,"laborHours":5,"partsPrice":2.6,"suppliesPrice":509.02,"laborPrice":36.9,"laborTax":4.3,"partsTax":2.4,"suppliesTax":4.1,"notes":"Et accusantium rerum."},{"operationCode":"TER", "description":"Mollitia unde nobis doloribus sed.","preApproved":true,"approved":false,"laborHours":5,"partsPrice":1.1,"suppliesPrice":71.7,"laborPrice":55.1,"laborTax":5.1,"partsTax":2.6,"suppliesTax":3.3,"notes":"Voluptates et aut debitis."}]',
        ];
        $this->requestAction('POST', '', $params);
        $this->assertEquals(Response::HTTP_BAD_REQUEST, $this->client->getResponse()->getStatusCode());
        ...
        $params = [
            'repairOrderID' => $repairOrderId,
            'recommendations' => '[{"operationCode":"MCS", "description":"","preApproved":true,"approved":true,"laborHours":5,"partsPrice":"string","suppliesPrice":14.02,"laborPrice":5.3,"laborTax":5.3,"partsTax":2.1,"suppliesTax":4.3,"notes":"Cumque tempora ut nobis.", "parts":["number":"34843434", "name":"name1", "price":23.3, "quantity":23,"bin":"eifkdo838f833kd9"]},{"operationCode":"VDF", "description":"Quidem earum sapiente at dolores quia natus.","preApproved":false,"approved":true,"laborHours":5,"partsPrice":2.6,"suppliesPrice":509.02,"laborPrice":36.9,"laborTax":4.3,"partsTax":2.4,"suppliesTax":4.1,"notes":"Et accusantium rerum."},{"operationCode":"TER", "description":"Mollitia unde nobis doloribus sed.","preApproved":true,"approved":false,"laborHours":5,"partsPrice":1.1,"suppliesPrice":71.7,"laborPrice":55.1,"laborTax":5.1,"partsTax":2.6,"suppliesTax":3.3,"notes":"Voluptates et aut debitis."}]',
        ];
        $this->requestAction('POST', '', $params);
        $this->assertEquals(Response::HTTP_BAD_REQUEST, $this->client->getResponse()->getStatusCode());
    }
    ...
    public function testCompleted()
    {
        ...
        $repairOrderQuoteRecommendation = $this->entityManager->getRepository(RepairOrderQuoteRecommendation::class)
            ...
            ->where("roqs.preApproved = true")
            ->setMaxResults(1)
            ->getQuery()
            ->getOneOrNullResult();
        $params = [
            'repairOrderQuoteID' => $repairOrderQuoteRecommendation->getRepairOrderQuote()->getId(),
        ...
        $repairOrderQuoteRecommendation = $this->entityManager->getRepository(RepairOrderQuoteRecommendation::class)
            ...
            ->getQuery()
            ->getOneOrNullResult();
        $repairOrderQuote = $repairOrderQuoteRecommendation->getRepairOrderQuote();
        $params = [
            'repairOrderQuoteID' => $repairOrderQuote->getId(),
            'recommendations' => '[{"repairOrderQuoteRecommendationId": 10001,"approved": false}]',
        ];
        $quoteStatus = $repairOrderQuote->getStatus();
        //the case when the quote status is Sent, Completed or Confirmed
        ...
        if ($repairOrderQuote) {
            ...
            if (count($recommendations) > 0) {
                ...
                foreach ($recommendations as $recommendation) {
                    $params['recommendations'] .= '{"repairOrderQuoteRecommendationId": ' . $recommendation->getId() . ',"approved": true},';
                }
                $params['recommendations'] = substr($params['recommendations'], 0, -1) . ']';
        ...
        foreach ($recommendations as $recommendation) {
            if (!$recommendation->getPreApproved()) {
                $params['recommendations'] .= '{"repairOrderQuoteRecommendationId": ' . $recommendation->getId() . ',"approved": false},';
            }
        }
        $params['recommendations'] = substr($params['recommendations'], 0, -1) . ']';
        $this->requestAction('POST', '/complete', $params);
    ...
    public function testConfirmed()
    {
        ...
        if ($repairOrderQuote) {
            //the case when repairOrderQuote is not allowed to be updated
            $params = [
                'repairOrderQuoteID' => $repairOrderQuote->getId(),
                'status' => 'Confirmed',
            ];
